...
\newproof{dokaz}{Dokaz izreka}
\newenwvironment{magic}[3]
{\begin{table}
   \caption{#2}
   \label{#3}
   \centering
...
% Začetek okolja izrek
 ...
 \begin{izrek}
     Magična konstanta normalnega magičnega kvadrata reda \(1+2+3+...+n^2=\sum_{k=1}^{n} k=\frac{1}{2}2n^2(n^2+1)\)
     je enaka
     \begin{equation}
      \label{eq:mc}
        % oznaka: eq:mc
...
Števila različnih normalnih magičnih kvadratov se nahajajo v tabeli \ref{table:svetila}.
% sklic: table:stevila
...
% Začetek tabele
  ...
  \begin{table}
      ...
      \begin{tabular}{lcccccc}\toprule
        ...
        red & 1 & 2 & 3 & 4 & 5 & 6 \\
        \hline
        število kvadratov & 1 & 0 & 1 & 880 & 275305224 & \((1,7745\pm0,0010)10^{19}\)\\
        \hline
        \bottomrule
      \end{tabular}
  \end{table}
