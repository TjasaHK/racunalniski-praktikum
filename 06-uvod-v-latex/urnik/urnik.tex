...
omejitve so bile kršene ter kolikokrat se kršitev pojavi. S \[k_1\cdot{u_1}\] označimo število
...
predstavljen z množico  \emph(.*). Posamezno srečanje je sestavljeno iz predmeta,
